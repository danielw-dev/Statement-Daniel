      ...
      setTranslate: function setTranslate(e, t) {
        ...
        if (Array.isArray(r))
          for (var o = 0; o < r.length; o += 1) {
            r[o] !== t && _instanceof(r[o], n) && l(r[o]);
          }
        else _instanceof(r, n) && t !== r && l(r);
      },
      setTransition: function setTransition(e, t) {
        var i,
          s = this,
        ...
        if (Array.isArray(r))
          for (i = 0; i < r.length; i += 1) {
            r[i] !== t && _instanceof(r[i], a) && n(r[i]);
          }
        else _instanceof(r, a) && t !== r && n(r);
      },
    },
    se = {
